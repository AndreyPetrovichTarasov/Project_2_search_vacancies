...
class Vacancy:
    ...
    def __init__(self, id_vacancy: str, name: str, url: str, description: str, salary: int) -> None:
        """Инициализатор класса с валидацией данных перед присвоением"""
    ...
    def cast_to_object_list(cls, hh_vacancies: List) -> List:
        """Метод класса, который создает список экземпляров класса из Python объекта"""
        vacancy_objects = []
